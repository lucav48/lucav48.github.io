...
Another research field of interest is the **Artificial Intelligence** one. In this case, there are two different research topics. The former regards a study of how Machine Learning can be used effectively in predicting user falls. The latter regards the **Explainable AI** (XAI) and **Model Compression**. In this setting, I am actually investigating the possible interpretation of deep convolutional neural networks through the Multilayer Networks and Complex Network Analysis. The aim of this research is to understand what happens under the hood of the deep network architecture thanks to the analysis of its relevant components and thanks to the exploration of patterns and features. This could also be useful to compress the deep learning model, and so to obtain a lighter version with fewer parameters and faster training and inference times.
<p style="text-align:center">
